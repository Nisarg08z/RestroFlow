...
const PhoneStep = ({ phone, setPhone, onSubmit, loading }) => {
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden selection:bg-primary/30">
            ...
            <div className="absolute top-0 left-0 w-[30rem] h-[30rem] bg-primary/10 rounded-full blur-[100px] pointer-events-none transform -translate-x-1/3 -translate-y-1/3" />
            <div className="absolute bottom-0 right-0 w-[30rem] h-[30rem] bg-primary/10 rounded-full blur-[100px] pointer-events-none transform translate-x-1/3 translate-y-1/3" />
            ...
            >
                <div className="text-center space-y-5">
                    ...
                    >
                        <h2 className="text-3xl font-black text-foreground tracking-tight">Your phone number</h2>
                ...
                <animated.form style={formSpring} onSubmit={onSubmit} className="space-y-6">
                    ...
                    >
                        ...
                        {loading ? (
                            ...
                            <>
                                <span className="z-10">Send OTP</span>
